  ...
  e.prototype = {
    ...
    _setupCodecs: function () {
      ...
      var t = o.canPlayType("audio/mpeg;").replace(/^no$/, ""),
        ...
        u = r.match(/Version\/(.*?) /),
        d = a && u && parseInt(u[1], 10) < 15;
      return (
        (e._codecs = {
          mp3: !(!t && !o.canPlayType("audio/mp3;").replace(/^no$/, "")),
          mpeg: !!t,
  ...
  o.prototype = {
      ...
      if (
        (1 === a.length || (2 === a.length && void 0 === a[1])
          ? r._getSoundIds().indexOf(a[0]) >= 0
            ? (o = parseInt(a[0], 10))
            : (e = parseFloat(a[0]))
          : a.length >= 2 && ((e = parseFloat(a[0])), (o = parseInt(a[1], 10))),
        !(void 0 !== e && e >= 0 && e <= 1))
      )
        return (t = o ? r._soundById(o) : r._sounds[0]), t ? t._volume : 0;
      ...
      for (var u = 0; u < o.length; u++)
        (t = r._soundById(o[u])) &&
          ...
          r._webAudio && t._node && !t._muted
            ...
            : t._node && !t._muted && (t._node.volume = e * n.volume()),
    ...
    rate: function () {
      ...
      if (0 === a.length) o = r._sounds[0]._id;
        ...
        var u = r._getSoundIds(),
          d = u.indexOf(a[0]);
        d >= 0 ? (o = parseInt(a[0], 10)) : (e = parseFloat(a[0]));
      } else
        2 === a.length && ((e = parseFloat(a[0])), (o = parseInt(a[1], 10)));
      if ("number" != typeof e)
        return (t = r._soundById(o)), t ? t._rate : r._rate;
      if ("loaded" !== r._state || r._playLock)
        return (
          r._queue.push({
            event: "rate",
      ...
      for (var i = 0; i < o.length; i++)
        if ((t = r._soundById(o[i]))) {
          ...
          var _ = r.seek(o[i]),
            s = (r._sprite[t._sprite][0] + r._sprite[t._sprite][1]) / 1e3 - _,
            l = (1e3 * s) / Math.abs(t._rate);
          (!r._endTimers[o[i]] && t._paused) ||
            (r._clearTimer(o[i]),
            (r._endTimers[o[i]] = setTimeout(r._ended.bind(r, t), l))),
            r._emit("rate", t._id);
        }
      return r;
    },
